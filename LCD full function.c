...
/*void LEDBlink(void)
{
	...
	delay_milli(500);
	//GPIO_PORTF_DATA_R = 0; // turn on the red led
	delay_milli(500);
}*/

/* this function is to check if delay function is working fine as
the lcd wasnot displaying any thing so we had to debug our code */
